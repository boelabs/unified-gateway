...
per-image pricing that the token-pricing schema cannot represent, and budget-only reasoning models
...
Embedding and image entries receive conservative adapter-level profiles; multimodal language models
